    ...
    const fetchStudent = async () => {
      try {
        ...
        if (data.data.photo_url) {
          setPhotoPreview(getImageUrl(data.data.photo_url));
        }
      } catch (err) {
  ...
  return (
    <div className="card">
      <div className="card-header">
        <div className="card-title">Edit Student - {formData.name}</div>
      </div>
        ...
        <div className="form-grid">
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) => handleInputChange({ target: { name: 'date_of_birth', value: e.target.value } })}
      ...
      : `${y}th Year`}
        ...
        <div style={{ display: 'flex', gap: '12px', marginTop: '28px', justifyContent: 'flex-end' }}>
          ...
          <button
            ...
            disabled={submitting}
          >
            <FiCheckCircle /> {submitting ? 'Updating...' : 'Update Student'}
          </button>
        </div>
      </form>
    </div>
